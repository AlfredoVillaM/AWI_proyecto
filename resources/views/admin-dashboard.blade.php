        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-8">
                <div class="relative inline-block">
                    ...
                    <p class="text-gray-500 text-base font-light tracking-wider mb-1 italic max-w-md mx-auto">Panel de control principal</p>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="mb-2">
                        <div class="flex items-center gap-3 mb-3">
                            <div class="w-14 h-14 rounded-full bg-linear-to-br from-purple-50 to-purple-100 flex items-center justify-center">
                                <svg class="w-7 h-7 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9 4.804A7.968 7.968 0 005.5 4c-1.255 0-2.443.29-3.5.804v10A7.969 7.969 0 015.5 14c1.669 0 3.218.51 4.5 1.385A7.962 7.962 0 0114.5 14c1.255 0 2.443.29 3.5.804v-10A7.968 7.968 0 0014.5 4c-1.255 0-2.443.29-3.5.804V12a1 1 0 11-2 0V4.804z"/>
                                </svg>
                            </div>
                            <div>
                                <h3 class="text-2xl font-bold text-gray-800">Libros registrados</h3>
                                <p class="text-gray-500 text-sm">Total de libros en la biblioteca</p>
                            </div>
                        </div>
                    </div>
                    <div class="flex items-end justify-between">
                        <div class="flex items-baseline gap-2">
                            <div class="text-5xl md:text-6xl font-bold text-purple-600">{{ $totalLibros }}</div>
                            <div class="text-gray-400 text-lg">libros</div>
                        </div>
                        <div class="text-right">
                            <div class="text-sm text-gray-400 mb-2">Inventario completo</div>
                            <div class="w-32 h-3 bg-gray-100 rounded-full overflow-hidden">
                                <div class="h-full bg-linear-to-r from-purple-500 to-purple-600 rounded-full" style="width: 100%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-2">
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm">Préstamos activos pendientes</p>
                            </div>
                        </div>
                    </div>
                    <div class="flex items-end justify-between">
                        ...
                        <div class="text-right">
                            <div class="text-sm text-gray-400 mb-2">
                                {{ $totalLibros > 0 ? round(($prestamosPendientes / $totalLibros) * 100, 1) : 0 }}% de libros
                            </div>
                            <div class="w-32 h-3 bg-gray-100 rounded-full overflow-hidden">
                                <div class="h-full bg-linear-to-r from-orange-400 to-orange-500 rounded-full" style="width: {{ $totalLibros > 0 ? min(100, ($prestamosPendientes / $totalLibros) * 100) : 0 }}%">
                                </div>
                            </div>
                        </div>
                    </div>
