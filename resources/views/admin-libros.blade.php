    ...
    <div class="p-6 bg-gray-50">
        ...
        @if($libros->isEmpty())
            <div class="text-center py-12 bg-white rounded-2xl border border-gray-200">
                ...
                <h4 class="text-lg font-semibold text-gray-700 mb-2">El catálogo está vacío</h4>
                <p class="text-sm text-gray-500">No hay libros registrados en el sistema</p>
            </div>
        @else
            ...
            <form method="POST" action="{{ route('admin-libros.save') }}" enctype="multipart/form-data" class="p-4" onsubmit="showLoadingSpinner(event, this)">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            <input name="portada" type="file" class="w-full px-4 py-2.5 bg-white border border-purple-100 rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-gradient-to-r file:from-purple-50 file:to-purple-100 file:text-purple-700 hover:file:from-purple-100 hover:file:to-purple-200 outline-none transition-all" accept="image/*" required />
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin-libros.update', $libro->id) }}" enctype="multipart/form-data" class="p-4" onsubmit="showLoadingSpinner(event, this)">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <div class="relative">
                                    <input name="portada" type="file" class="w-full px-4 py-2.5 bg-white border border-blue-100 rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-gradient-to-r file:from-blue-50 file:to-blue-100 file:text-blue-700 hover:file:from-blue-100 hover:file:to-blue-200 outline-none transition-all" accept="image/*" />
                                </div>
                    ...
                    <form method="POST" action="{{ route('admin-libros.delete', $libro->id) }}" class="p-6" onsubmit="showLoadingSpinner(event, this)">
                        ...
                        <div class="text-center">
                            ...
                            <div class="pt-6 border-t border-red-100 flex justify-center gap-3">
                                ...
                                <button type="submit" class="submit-btn cursor-pointer px-5 py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg font-medium hover:from-red-600 hover:to-red-700 transition-all duration-200 shadow-sm hover:shadow-md shadow-red-200 relative">
